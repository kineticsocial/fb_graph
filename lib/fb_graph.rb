...
require 'fb_graph/ad_interest'
require 'fb_graph/ad_interest_suggestion'
require 'fb_graph/ad_interest_valid'
require 'fb_graph/ad_targeting_category'
require 'fb_graph/business_manager'
require 'fb_graph/report_stat'
...
require  'fb_graph/ad_reach_frequency'
